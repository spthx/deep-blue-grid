...
fourth game mode, `MISSION`, contains twenty-eight independently selectable missions:
sixteen tactical, five archive, and seven extreme. The library-wide contract is defined in
...
- Four original core MISSION definitions with IDs 1–4 and fixed seeds; the
  complete twenty-eight-definition library (16 tactical, 5 archive, 7 extreme)
